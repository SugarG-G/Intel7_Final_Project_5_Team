    ...
    void send_sequence(const std::vector<std::string> &seq, int delay_sec)
    {
        for (const auto &cmd : seq) {
            if (!send_uart_line(cmd)) {
                ...
                RCLCPP_INFO(this->get_logger(), "stm32로 전송됨: %s", cmd.c_str());
            }
        ...
        std::shared_ptr<RobotArmCommand::Response> response)
    {
        ...
        if (command == "detect") {
            const std::vector<std::string> seq = {
                ...
                "600@1500@1800@1600@1900@1500", //집게 벌림
                "1700@1500@1800@1600@1900@1500", //물체 잡기
                "1700@1500@1700@1500@1700@1500", //놓기 준비
            ...
            const std::vector<std::string> seq = {
                 "500@1500@1800@1500@1500@500",
                 "2500@1500@2000@1500@1700@500"
