...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/turtlebot3_patrol/config', [
            'turtlebot3_example/turtlebot3_patrol/config/waypoints.yaml'
        ]),
    ],
    ...
    entry_points={
        'console_scripts': [
            ...
            'turtlebot3_patrol_stop_dummy = \
                turtlebot3_example.turtlebot3_patrol.turtlebot3_patrol_stop_dummy:main',

            'turtlebot3_patrol_share_server = \
                turtlebot3_example.turtlebot3_patrol.patrol_share_server:main',
            ...
            ,
            'turtlebot3_platoon_guard = '
            'turtlebot3_example.turtlebot3_patrol.platoon_guard:main'
            ,
            'sup_order = '
            'turtlebot3_example.turtlebot3_patrol.sup_order:main'
        ],
    },
)
