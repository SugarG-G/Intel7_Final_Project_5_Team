...
#include "robot_arm/srv/detail/robot_arm_command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_arm::srv::RobotArmCommand_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_arm::srv::RobotArmCommand_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_arm::srv::RobotArmCommand_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RobotArmCommand_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const robot_arm::srv::RobotArmCommand_Request *>(
...
static size_t _RobotArmCommand_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RobotArmCommand_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RobotArmCommand_Request__callbacks = {
  "robot_arm::srv",
...
static rosidl_message_type_support_t _RobotArmCommand_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RobotArmCommand_Request__callbacks,
...
{
  return &robot_arm::srv::typesupport_fastrtps_cpp::_RobotArmCommand_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_arm::srv::RobotArmCommand_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_arm::srv::RobotArmCommand_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robot_arm::srv::RobotArmCommand_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RobotArmCommand_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const robot_arm::srv::RobotArmCommand_Response *>(
...
static size_t _RobotArmCommand_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RobotArmCommand_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RobotArmCommand_Response__callbacks = {
  "robot_arm::srv",
...
static rosidl_message_type_support_t _RobotArmCommand_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RobotArmCommand_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &robot_arm::srv::typesupport_fastrtps_cpp::_RobotArmCommand_Response__handle;
}
...
static service_type_support_callbacks_t _RobotArmCommand__callbacks = {
  "robot_arm::srv",
  "RobotArmCommand",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_arm, srv, RobotArmCommand_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_arm, srv, RobotArmCommand_Response)(),
...
static rosidl_service_type_support_t _RobotArmCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RobotArmCommand__callbacks,
...
{
  return &robot_arm::srv::typesupport_fastrtps_cpp::_RobotArmCommand__handle;
}
